...
private:
	...
	CS8ServerV1Proxy *mCS8ServerV2;
	CS8ServerV3Proxy *mCS8ServerV3;
	_ns1__login *mLogin;
	_ns1__loginResponse *mLoginResponse;

public:
	TX60() : mIsLoggedIn(false), mCS8ServerV0(NULL), mLogin(NULL), mLoginResponse(NULL), mCS8ServerV1(NULL), mCS8ServerV2(NULL), mCS8ServerV3(NULL){}
	//------------------Server V0----------------//
